    <div id="mainContent">
         ...
         <h3>Crea tu torneo <span class="resaltado">PÚBLICO</span> en 4 Pasos ó uno <span class="resaltado"><a href="/starcrafty/torneos/crearpriv">PRIVADO (IN HOME)</a></span></h3> 
	...
	<div id="crearTorneo">
	    ...
	    <form method="post" id="crearTorneoForm" enctype="multipart/form-data" action="/starcrafty/torneos/nuevo/publico">
	        <div class="crearTorneoContent" id="principal">
	            ...
	            <input type="text" name="auspiciador" id="auspiciador">
	            <button id="agregarAuspiciador">Añadir a la lista</button></p>
	            <p><textarea name="auspiciadores" disabled="disabled"></textarea></p>
	            <p><label for="tags">Tags </label><input type="text" name="tags"><span class="advice"> Separar con espacios ' '</span></p>
	            <p><label for="file">Reglas </label><input type="file" name="reglas" /></p>                                       
	        ...
	        <div class="crearTorneoContent" id="detalles">
	            ...
	            <p><label for="numeroJugadores">Número de Jugadores </label><input type="number" name="numeroJugadores"><span class="asterisco"> *</span><span class="advice"> El número de jugadores debe ser: 4 | 8 | 16 | 32 ...</span></p>
	            <p>Premios</p>
	            ...
	            <p><label for="referees">Referees </label><textarea name="referees"></textarea><span class="asterisco"> *</span></p>
